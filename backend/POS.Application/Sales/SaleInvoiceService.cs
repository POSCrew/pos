...
public sealed class SaleInvoiceService : ISaleInvoiceService
{
    ...
    public SaleInvoiceService(IRepository<SaleInvoice> repository, ITransactionManager transactionManager, IRepository<SaleInvoiceItem> itemRepository, IGeneralService generalService, ICustomerService customerService, IItemService itemService, IPricingService pricingService)
    {
